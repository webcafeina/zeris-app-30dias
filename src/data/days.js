...
export const DAYS = [
  ...
  // ====================================================================
  {
    ...
    targetTime: [150, 200],
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · vierte 28 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl suave (sin cuchara)' },
      { at: 40, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g, haciéndolo en círculos' },
      { at: 80, action: 'pour', water: 160, label: 'Vierte agua hasta los 160 g, haciéndolo en círculos' },
      { at: 120, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g, haciéndolo en círculos' },
  ...
  },
  {
    ...
    targetTime: [150, 200],
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · vierte 28 g de agua en 8 s' },
      { at: 10, action: 'swirl', label: 'Swirl inmediato y observa cúpula' },
      { at: 40, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g' },
      { at: 80, action: 'pour', water: 165, label: 'Vierte agua hasta los 165 g' },
      { at: 120, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g' },
  ...
  },
  {
    ...
    targetTime: [150, 200],
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua · 5 g/s' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 90, label: 'Vierte agua hasta los 90 g · ~12 s' },
      { at: 70, action: 'pour', water: 155, label: 'Vierte agua hasta los 155 g · ~13 s' },
      { at: 105, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g · ~15 s' },
  ...
  },
  {
    ...
    targetTime: [150, 200],
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g' },
      { at: 80, action: 'pour', water: 165, label: 'Vierte agua hasta los 165 g' },
      { at: 120, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g · APUNTA ESTE TIEMPO' },
  ...
  // ====================================================================
  {
    ...
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 45, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g' },
      { at: 90, action: 'pour', water: 165, label: 'Vierte agua hasta los 165 g' },
      { at: 135, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g' },
  ...
  },
  {
    ...
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 35, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g' },
      { at: 65, action: 'pour', water: 165, label: 'Vierte agua hasta los 165 g' },
      { at: 95, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g' },
  ...
  },
  {
    ...
    targetTime: [150, 200],
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua · 96 °C' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g' },
      { at: 80, action: 'pour', water: 165, label: 'Vierte agua hasta los 165 g' },
      { at: 120, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g' },
  ...
  },
  {
    ...
    targetTime: [160, 220],
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua · 88 °C' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 100, label: 'Vierte agua hasta los 100 g' },
      { at: 80, action: 'pour', water: 165, label: 'Vierte agua hasta los 165 g' },
      { at: 120, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g' },
  ...
  },
  {
    ...
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 90, label: 'Vierte agua hasta los 90 g' },
      { at: 75, action: 'pour', water: 145, label: 'Vierte agua hasta los 145 g' },
      { at: 110, action: 'pour', water: 196, label: 'Vierte agua hasta los 196 g' },
  ...
  },
  {
    ...
    steps: [
      { at: 0, action: 'pour', water: 28, label: 'BLOOM · 28 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 110, label: 'Vierte agua hasta los 110 g' },
      { at: 80, action: 'pour', water: 180, label: 'Vierte agua hasta los 180 g' },
      { at: 120, action: 'pour', water: 252, label: 'Vierte agua hasta los 252 g' },
      { at: 150, action: 'drain', label: 'Drawdown' },
    ]
  },
  {
  ...
  // ====================================================================
  {
    ...
    targetTime: [150, 200],
    steps: [
      { at: 0, action: 'pour', water: 36, label: 'BLOOM · 36 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 130, label: 'Vierte agua hasta los 130 g' },
      { at: 80, action: 'pour', water: 215, label: 'Vierte agua hasta los 215 g' },
      { at: 120, action: 'pour', water: 300, label: 'Vierte agua hasta los 300 g' },
      { at: 145, action: 'rao', label: 'Rao spin' },
  ...
  },
  {
    ...
    targetTime: [120, 160],
    steps: [
      { at: 0, action: 'pour', water: 36, label: 'BLOOM · 36 g de agua, haciéndolo en círculos' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 130, label: 'Vierte agua hasta los 130 g, haciéndolo en círculos' },
      { at: 75, action: 'pour', water: 215, label: 'Vierte agua hasta los 215 g · CENTRAL' },
      { at: 105, action: 'pour', water: 300, label: 'Vierte agua hasta los 300 g · CENTRAL' },
  ...
  },
  {
    ...
    steps: [
      ...
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 130, label: 'Vierte agua hasta los 130 g, haciéndolo en círculos' },
      { at: 80, action: 'pour', water: 215, label: 'Vierte agua hasta los 215 g · mezcla' },
      { at: 120, action: 'pour', water: 300, label: 'Vierte agua hasta los 300 g · central' },
      { at: 150, action: 'drain', label: 'Drawdown' },
    ]
  },
  {
  ...
  },
  {
    ...
    targetTime: [180, 230],
    steps: [
      { at: 0, action: 'pour', water: 45, label: 'BLOOM · 45 g de agua' },
      { at: 5, action: 'swirl', label: 'Swirl inmediato' },
      { at: 45, action: 'pour', water: 150, label: 'Vierte agua hasta los 150 g (30 s)' },
      { at: 95, action: 'pour', water: 250, label: 'Vierte agua hasta los 250 g (30 s)' },
  ...
  },
  {
    ...
    targetTime: [170, 200],
    steps: [
      { at: 0, action: 'pour', water: 50, label: 'BLOOM · 50 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
  ...
  },
  {
    ...
    steps: [
      { at: 0, action: 'pour', water: 36, label: 'BLOOM · 36 g de agua' },
      { at: 10, action: 'swirl', label: 'Swirl' },
      { at: 40, action: 'pour', water: 120, label: 'Vierte agua hasta los 120 g' },
      { at: 80, action: 'pour', water: 190, label: 'Vierte agua hasta los 190 g' },
      { at: 120, action: 'pour', water: 260, label: 'Vierte agua hasta los 260 g' },
  ...
  },
  {
    ...
    targetTime: [140, 160],
    steps: [
      { at: 0, action: 'pour', water: 30, label: 'BLOOM · 30 g de agua · espiral lenta' },
      { at: 15, action: 'swirl', label: 'Swirl suave' },
      { at: 45, action: 'pour', water: 110, label: 'Vierte agua hasta los 110 g · espiral lenta' },
      { at: 85, action: 'pour', water: 175, label: 'Vierte agua hasta los 175 g · espiral lenta' },
      { at: 120, action: 'pour', water: 230, label: 'Vierte agua hasta los 230 g · espiral lenta' },
